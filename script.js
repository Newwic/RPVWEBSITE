...
Object.assign(ui.th, {
  aboutEyebrow: "เกี่ยวกับเรา / ABOUT",
  aboutHeroText: "บริษัท อาร์พีวี อินดัสเทรียล ซัพพลาย จำกัด ผู้นำเข้าและตัวแทนจำหน่ายเครื่องขัดโลหะ เครื่องพ่นทราย ทรายพ่น หินขัด และอุปกรณ์สำหรับงานเตรียมผิวอุตสาหกรรม",
  aboutStoryEyebrow: "ประวัติความเป็นมา",
  aboutStoryTitle: "ผู้เชี่ยวชาญด้านงานขัด พ่นทราย และเตรียมผิวโลหะ",
  aboutStoryText1: "เราคือผู้นำเข้า และตัวแทนจำหน่าย เครื่องขัดโลหะ เครื่องพ่นทราย ทรายพ่น หินขัด เกือบทุกชนิด ทุกประเภท และหลากหลายขนาด ด้วยทีมงานที่มีประสบการณ์ในธุรกิจมากกว่า 20 ปี",
  aboutStoryText2: "RPV สามารถให้คำแนะนำด้านงานเตรียมผิว ทั้งงานพ่นทราย งานขัด ขัดลบครีบ ลบคม และขัดเงา ในหลายอุตสาหกรรม ตั้งแต่อุตสาหกรรมครัวเรือน ไปจนถึงอุตสาหกรรมขนาดใหญ่ เช่น เครื่องประดับ แม่พิมพ์ ชิ้นส่วนยานยนต์ ก่อสร้าง และปิโตรเลียม",
  aboutStoryText3: "บริษัทมีความพร้อมในการให้คำปรึกษาและทดสอบชิ้นงานขัด พ่น และเตรียมผิวโลหะอย่างครบวงจร โดยมีสต็อกสินค้าประเภทวัสดุสิ้นเปลืองพร้อมส่ง เพื่อให้บริการได้รวดเร็วและตอบสนองความต้องการของลูกค้าอย่างมีประสิทธิภาพ",
  aboutFactsTitle: "ข้อมูลบริษัท",
  aboutFoundedLabel: "ก่อตั้ง",
  aboutFoundedValue: "18 กันยายน 2555",
  aboutCapitalLabel: "ทุนจดทะเบียน",
  aboutCapitalValue: "5,000,000 บาท",
  aboutDirectorLabel: "กรรมการผู้จัดการ",
  aboutDirectorValue: "นางรัตนา สันติอภิรักษ์",
  aboutOfficeLabel: "สำนักงานและคลังสินค้า",
  aboutOfficeValue: "พื้นที่ 800 ตรม.",
  aboutLocationLabel: "ที่ตั้ง",
  aboutLocationValue: "21/62 หมู่ 3 ต.ลำโพ อ.บางบัวทอง จ.นนทบุรี 11110",
  aboutVisionEyebrow: "วิสัยทัศน์",
  aboutVisionText: "เรามุ่งมั่นเป็นผู้นำด้านการขัดและเตรียมผิวโลหะครบวงจรในประเทศไทย ด้วยนวัตกรรมล้ำสมัย คุณภาพที่เชื่อถือได้ และความใส่ใจต่อสิ่งแวดล้อม เพื่อยกระดับมาตรฐานอุตสาหกรรมและสร้างความพึงพอใจสูงสุดแก่ลูกค้า",
  aboutServicesEyebrow: "สินค้าและบริการของเรา",
  aboutServicesTitle: "ครอบคลุมงานขัด งานพ่นทราย วัสดุขัด และบริการที่เกี่ยวข้อง",
  aboutService1Title: "ด้านงานขัด",
  aboutService1Text: "เครื่องขัดโลหะและอุปกรณ์สำหรับงานลบคม ขัดผิว ขัดเงา และเตรียมผิวชิ้นงาน",
  aboutService1Item1: "เครื่องขัดแบบเขย่า (Vibratory Machine)",
  aboutService1Item2: "เครื่องขัดแบบจานหมุน (Centrifugal Disc Machine)",
  aboutService1Item3: "เครื่องขัดแบบถังกลิ้ง แบบช้าและแบบเร็ว",
  aboutService1Item4: "เครื่องอบแห้ง และเครื่องแยกชิ้นงาน",
  aboutService1Item5: "เครื่องขัดเงาแผ่นสแตนเลส 8K Mirror Polishing",
  aboutService1Item6: "เครื่องขัดระบบแม่เหล็ก และระบบอัลตราโซนิก",
  aboutService1Item7: "หินขัด น้ำยาขัด (Media & Compound)",
  aboutService2Title: "ด้านงานพ่นทราย",
  aboutService2Text: "เครื่องพ่นทราย ระบบลม ระบบออโต้ และวัสดุพ่นทรายหลายชนิดสำหรับงานเตรียมผิว",
  aboutService2Item1: "เครื่องพ่นทรายแบบตู้พ่น ระบบแรงดันและระบบแรงดูด",
  aboutService2Item2: "เครื่องพ่นทรายกลางแจ้ง (Outdoor Blasting Machine)",
  aboutService2Item3: "Glass Beads, Crush Glass, Copper Slag, Garnet Sand",
  aboutService2Item4: "Brown & White Aluminium Oxide, Silicon Carbide",
  aboutService2Item5: "Plastic Abrasives, Nylon Media, Walnut Shell, Corn Cob",
  aboutService2Item6: "Ceramic Beads และเม็ดโลหะ/อโลหะชนิดต่าง ๆ",
  aboutService3Title: "เม็ดโลหะและอุปกรณ์พ่นทราย",
  aboutService3Text: "วัสดุและอะไหล่สำหรับเครื่องพ่นทราย เพื่อรองรับงานใช้งานจริงในโรงงาน",
  aboutService3Item1: "Copper Cut Wire, Zinc Shot, Zinc Cut Wire",
  aboutService3Item2: "Stainless Shot, Stainless Cut Wire",
  aboutService3Item3: "Aluminium Shot, Aluminium Cut Wire",
  aboutService3Item4: "Steel Grit, Steel Shot",
  aboutService3Item5: "หมวกพ่นทราย ชุดคลุม สายพ่น หัวพ่น ถุงมือ ข้อต่อ ถุงกรองฝุ่น และกระจก",
  aboutService4Title: "ด้านงานบริการ",
  aboutService4Text: "บริการเสริมสำหรับลูกค้าที่ต้องการทดสอบ ซ่อมแซม หรือใช้งานเครื่องจักรเฉพาะช่วงเวลา",
  aboutService4Item1: "บริการเคลือบยางและเคลือบ PU ถังขัด",
  aboutService4Item2: "บริการรับขัดและพ่นทราย",
  aboutService4Item3: "บริการซ่อมเครื่องพ่นทรายและเครื่องขัด",
  aboutService4Item4: "บริการให้เช่าเครื่องพ่นทรายกลางแจ้ง",
  aboutService4Item5: "บริการ Bowl Feeder และเครื่องลำเลียงชิ้นงาน",
  aboutService4Item6: "บริการลอกสี Hanger และ Jig จับชิ้นงาน",
  aboutContactTitle: "ต้องการปรึกษางานขัดหรืองานพ่นทราย?",
  aboutContactText: "ส่งรูปชิ้นงาน วัสดุ ปัญหาผิว และผลลัพธ์ที่ต้องการมาให้ทีมงานช่วยแนะนำ"
});

Object.assign(ui.en, {
  aboutEyebrow: "ABOUT RPV",
  aboutHeroText: "RPV Industrial Supply Co., Ltd. imports and distributes metal polishing machines, blasting machines, blasting media, polishing media, and equipment for industrial surface preparation.",
  aboutStoryEyebrow: "OUR STORY",
  aboutStoryTitle: "Specialists in polishing, blasting, and metal surface preparation",
  aboutStoryText1: "We import and distribute metal polishing machines, blasting machines, blasting media, polishing media, and equipment in a wide range of types and sizes. Our team has more than 20 years of experience in this business.",
  aboutStoryText2: "RPV advises on surface preparation, including blasting, polishing, deburring, edge finishing, and bright polishing across many industries—from household products to large-scale sectors such as jewelry, molds, automotive parts, construction, and petroleum.",
  aboutStoryText3: "We provide end-to-end consultation and workpiece testing for polishing, blasting, and metal surface preparation. Consumable media are stocked and ready to ship, enabling fast and effective service.",
  aboutFactsTitle: "COMPANY FACTS",
  aboutFoundedLabel: "Founded",
  aboutFoundedValue: "18 September 2012",
  aboutCapitalLabel: "Registered capital",
  aboutCapitalValue: "THB 5,000,000",
  aboutDirectorLabel: "Managing director",
  aboutDirectorValue: "นางรัตนา สันติอภิรักษ์",
  aboutOfficeLabel: "Office and warehouse",
  aboutOfficeValue: "800 sq. m.",
  aboutLocationLabel: "Location",
  aboutLocationValue: "21/62 Moo 3, Lam Pho, Bang Bua Thong, Nonthaburi 11110, Thailand",
  aboutVisionEyebrow: "OUR VISION",
  aboutVisionText: "We aim to be Thailand's trusted leader in complete metal polishing and surface preparation, combining modern innovation, dependable quality, and environmental care to raise industry standards and deliver lasting customer satisfaction.",
  aboutServicesEyebrow: "OUR PRODUCTS AND SERVICES",
  aboutServicesTitle: "Polishing, blasting, abrasive media, and related services",
  aboutService1Title: "POLISHING SOLUTIONS",
  aboutService1Text: "Metal polishing machines and equipment for deburring, surface finishing, polishing, and workpiece preparation.",
  aboutService1Item1: "Vibratory machines",
  aboutService1Item2: "Centrifugal disc machines",
  aboutService1Item3: "Slow- and fast-rotating barrel machines",
  aboutService1Item4: "Dryers and part separators",
  aboutService1Item5: "8K mirror polishing machines for stainless steel sheets",
  aboutService1Item6: "Magnetic and ultrasonic polishing systems",
  aboutService1Item7: "Polishing media and compounds",
  aboutService2Title: "BLASTING SOLUTIONS",
  aboutService2Text: "Blast machines, air systems, automatic systems, and a wide range of blasting media for surface preparation.",
  aboutService2Item1: "Cabinet blast machines with pressure and suction systems",
  aboutService2Item2: "Outdoor blasting machines",
  aboutService2Item3: "Glass beads, crushed glass, copper slag, and garnet sand",
  aboutService2Item4: "Brown and white aluminum oxide, and silicon carbide",
  aboutService2Item5: "Plastic abrasives, nylon media, walnut shell, and corn cob",
  aboutService2Item6: "Ceramic beads and various metal and non-metal shot",
  aboutService3Title: "METAL ABRASIVES AND BLASTING EQUIPMENT",
  aboutService3Text: "Media and spare parts for blasting machines, supporting real-world factory operations.",
  aboutService3Item1: "Copper cut wire, zinc shot, and zinc cut wire",
  aboutService3Item2: "Stainless shot and stainless cut wire",
  aboutService3Item3: "Aluminum shot and aluminum cut wire",
  aboutService3Item4: "Steel grit and steel shot",
  aboutService3Item5: "Sandblasting helmets, protective suits, blast hoses, nozzles, gloves, couplings, dust filter bags, and viewing glass",
  aboutService4Title: "SERVICE SOLUTIONS",
  aboutService4Text: "Additional services for customers who need testing, repairs, or machinery for a specific period.",
  aboutService4Item1: "Rubber and PU lining for tumbling barrels",
  aboutService4Item2: "Polishing and blasting services",
  aboutService4Item3: "Blasting and polishing machine repairs",
  aboutService4Item4: "Outdoor blasting machine rental",
  aboutService4Item5: "Bowl feeder and workpiece conveyor services",
  aboutService4Item6: "Hanger and workholding jig paint stripping",
  aboutContactTitle: "Need advice on polishing or blasting?",
...
const showcaseSlides = [
  {
    ...
    text: {
      th: "เริ่มดูระบบเครื่องขัดสำหรับงานลบครีบ ลบคม และเก็บผิวชิ้นงาน",
      en: "Explore polishing systems for deburring, edge finishing, and surface refinement."
    },
    alt: { th: "เครื่องขัดผิว RPV", en: "RPV polishing machine" },
  ...
  },
  {
    ...
    text: {
      th: "ดูหมวดงานขัดละเอียดและโซลูชันสำหรับงานผิวที่ต้องการความสม่ำเสมอ",
      en: "Explore fine finishing and surface solutions where consistency matters."
    },
    alt: { th: "ระบบขัดแม่เหล็ก RPV", en: "RPV magnetic polishing system" },
  ...
  },
  {
    ...
    text: {
      th: "เริ่มจากระบบพ่นทรายและอุปกรณ์สำหรับงานเตรียมผิวและงานภาคสนาม",
      en: "Start with blasting systems and equipment for surface preparation and field work."
    },
    alt: { th: "เครื่องพ่นทราย RPV", en: "RPV blasting equipment" },
  ...
  },
  {
    ...
    text: {
      th: "เลือกดูวัสดุพ่นและเม็ดขัดจากหมวดสินค้าที่มีอยู่ในเว็บไซต์",
      en: "Browse blasting media and abrasives from the categories available on the site."
    },
    alt: { th: "วัสดุทรายพ่น RPV", en: "RPV blasting abrasive" },
  ...
  },
  {
    ...
    text: {
      th: "ดูวัสดุขัดและน้ำยาที่ใช้ร่วมกับกระบวนการขัดผิว",
      en: "Explore media and compounds used alongside surface finishing processes."
    },
    alt: { th: "หินขัดและน้ำยา RPV", en: "RPV media and compound" },
  ...
  },
  {
    ...
    text: {
      th: "ถ้ายังไม่แน่ใจ ส่งรายละเอียดงานหรือรูปชิ้นงานให้ทีม RPV ช่วยแนะนำได้",
      en: "If you are not sure where to start, share your work details or part photo with the RPV team."
    },
    alt: { th: "บริการ RPV", en: "RPV support service" },
    href: "products.html?group=services"
  }
];
...
function renderShowcase() {
  if (!rpvShowcase || !showcaseStage || !showcaseDots) return;
  ...
  showcaseSlides.forEach((item, index) => {
    ...
    dot.type = "button";
    dot.dataset.showcaseDot = String(index);
    dot.setAttribute("role", "tab");
    dot.setAttribute("aria-selected", String(index === showcaseIndex));
    dot.setAttribute("aria-label", `${showcaseCopy("slide")} ${index + 1}: ${item.title[language] || item.title.th}`);
    dot.classList.toggle("is-active", index === showcaseIndex);
...
function goToShowcase(index) {
  showcaseIndex = (index + showcaseSlides.length) % showcaseSlides.length;
  renderShowcase();
}
...
function applyShowcaseLanguage() {
  ...
  rpvShowcase.querySelectorAll("[data-showcase-i18n]").forEach((element) => {
    const value = showcaseCopy(element.dataset.showcaseI18n);
    if (value) element.textContent = value;
  });

  rpvShowcase.querySelector('[data-showcase-action="prev"]')?.setAttribute("aria-label", showcaseCopy("prev"));
  rpvShowcase.querySelector('[data-showcase-action="next"]')?.setAttribute("aria-label", showcaseCopy("next"));
  renderShowcase();
}
...
rpvShowcase?.addEventListener("click", (event) => {
  const actionButton = event.target.closest("[data-showcase-action]");
  const dotButton = event.target.closest("[data-showcase-dot]");

  if (actionButton?.dataset.showcaseAction === "prev") {
    goToShowcase(showcaseIndex - 1);
    startShowcaseTimer();
    return;
  }

  if (actionButton?.dataset.showcaseAction === "next") {
    goToShowcase(showcaseIndex + 1);
    startShowcaseTimer();
    return;
  }
  ...
  if (dotButton) {
    goToShowcase(Number(dotButton.dataset.showcaseDot));
    startShowcaseTimer();
  }
});

rpvShowcase?.addEventListener("mouseenter", stopShowcaseTimer);
rpvShowcase?.addEventListener("mouseleave", startShowcaseTimer);
